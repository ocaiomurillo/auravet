...
const buildBaseModules = (): ModuleRecord[] => {
  ...
  return [
    ...
    },
    {
      ...
      name: 'Gerenciar agendamentos (legado)',
      description: 'Permite criar, reagendar e cancelar consultas e procedimentos.',
      isActive: true,
      createdAt: now,
      updatedAt: now,
...
const buildBaseRoleModules = (): RoleModuleRecord[] => [
  ...
  { roleId: ROLE_IDS.ADMINISTRADOR, moduleId: 'products:read', isEnabled: true },
  { roleId: ROLE_IDS.ADMINISTRADOR, moduleId: 'products:write', isEnabled: true },
  { roleId: ROLE_IDS.ADMINISTRADOR, moduleId: 'appointments:manage', isEnabled: true },
  { roleId: ROLE_IDS.ADMINISTRADOR, moduleId: 'users:manage', isEnabled: true },
  { roleId: ROLE_IDS.ADMINISTRADOR, moduleId: 'cashier:manage', isEnabled: true },
  ...
  { roleId: ROLE_IDS.AUXILIAR_ADMINISTRATIVO, moduleId: 'appointments:manage', isEnabled: true },
  { roleId: ROLE_IDS.AUXILIAR_ADMINISTRATIVO, moduleId: 'products:read', isEnabled: true },
  { roleId: ROLE_IDS.AUXILIAR_ADMINISTRATIVO, moduleId: 'products:write', isEnabled: true },
  { roleId: ROLE_IDS.AUXILIAR_ADMINISTRATIVO, moduleId: 'cashier:manage', isEnabled: true },
  ...
  { roleId: ROLE_IDS.ASSISTENTE_ADMINISTRATIVO, moduleId: 'services:write', isEnabled: true },
  { roleId: ROLE_IDS.ASSISTENTE_ADMINISTRATIVO, moduleId: 'products:read', isEnabled: true },
  { roleId: ROLE_IDS.ASSISTENTE_ADMINISTRATIVO, moduleId: 'cashier:manage', isEnabled: true },
  ...
  { roleId: ROLE_IDS.ENFERMEIRO, moduleId: 'appointments:manage', isEnabled: true },
  { roleId: ROLE_IDS.ENFERMEIRO, moduleId: 'products:read', isEnabled: true },
  { roleId: ROLE_IDS.ENFERMEIRO, moduleId: 'products:write', isEnabled: true },
  ...
  { roleId: ROLE_IDS.MEDICO, moduleId: 'appointments:manage', isEnabled: true },
  { roleId: ROLE_IDS.MEDICO, moduleId: 'products:read', isEnabled: true },
  { roleId: ROLE_IDS.CONTADOR, moduleId: 'services:read', isEnabled: true },
  { roleId: ROLE_IDS.CONTADOR, moduleId: 'products:read', isEnabled: true },
  { roleId: ROLE_IDS.CONTADOR, moduleId: 'cashier:manage', isEnabled: true },
];
